...
import { Image as ImageIcon, Loader2, Download, Upload, X, Wand2, Crop, Maximize, Settings2, Sparkles, Sun, Contrast, Droplets, Palette, RotateCcw, ShieldCheck, ZoomIn, ZoomOut, History, Trash2, Zap } from 'lucide-react';
  ...
  const refinePrompt = async () => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: `Expand this simple image prompt into a highly detailed, creative, and descriptive prompt for an AI image generator. Focus on lighting, style, and composition. Keep it under 40 words. Prompt: "${prompt}"`,
      });
      if (response.text) {
